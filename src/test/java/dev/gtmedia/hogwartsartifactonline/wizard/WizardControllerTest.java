...
class WizardControllerTest {
    ...
    @Autowired
    private WizardToWizardDTOInternalConverter wizardToWizardDTOInternalConverter;
...
//    ObjectMapper objectMapper;
    ...
    void testFindAllWizardsSuccess() throws Exception {
        ...
        given(this.wizardService.findAllWizards()).willReturn(wizardToWizardDTOInternalConverter.convert(this.wizards));

        // When and then
        this.mockMvc.perform(get("/wizards").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(200))
                .andExpect(jsonPath("$.message").value("All wizards fetched"));
